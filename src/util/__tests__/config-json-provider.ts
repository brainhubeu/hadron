...
describe ("configJsonProvider", () => {
    it ("should return object", () => {
        return configJsonProvider(["src/util/__tests__/mock/app/config/*"], "config", "development", ["js"])
        .then((result) => {
    ...
    it ("should return JavaScript object from json and xml files", () => {
        ...
        return configJsonProvider(["src/util/__tests__/mock/app/config/*"], "config", "development", ["json", "xml"])
        .then((result) => {
            expect(result).to.be.deep.equal(validObject);
        });
    });
    ...
    it ("should return JavaScript object from json and js files", () => {
        ...
        return configJsonProvider(["src/util/__tests__/mock/app/config/*"], "config", "development", ["json", "js"])
        .then((result) => {
            expect(result).to.be.deep.equal(validObject);
        });
    });
